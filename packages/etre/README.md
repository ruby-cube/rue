...
In this system, composition and inheritance is achieved through the concepts of abstract roles and prereqs. An abstract role can be defined as having other abstract roles as prereqs. The instantiated role will possess all the properties and methods of the role as well as all the properties and methods of its prereqs and its prereqs’ prereqs… all the way up the lines of inheritance.
